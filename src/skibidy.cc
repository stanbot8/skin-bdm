...
void bdm::skibidy::SimParam::LoadConfig(const skibidy::TomlConfig& config) {
  ...
  BDM_ASSIGN_CONFIG_VALUE(vegf_migration_weight, "skin.vegf_migration_weight");
  BDM_ASSIGN_CONFIG_VALUE(fibronectin_haptotaxis_weight, "skin.fibronectin_haptotaxis_weight");
  ...
  BDM_ASSIGN_CONFIG_VALUE(diabetic_macrophage_apoptosis_factor, "skin.diabetic.macrophage_apoptosis_factor");
  ...
  BDM_ASSIGN_CONFIG_VALUE(diabetic_timp_production_factor, "skin.diabetic.timp_production_factor");
  ...
  BDM_ASSIGN_HOURS(fibroblast_activated_apoptosis_onset, "skin.fibroblast.activated_apoptosis_onset_h");
  BDM_ASSIGN_CONFIG_VALUE(fibroblast_activated_apoptosis_rate, "skin.fibroblast.activated_apoptosis_rate");
  ...
  BDM_ASSIGN_CONFIG_VALUE(tgfb_receptor_consumption, "skin.fibroblast.tgfb_receptor_consumption");
  BDM_ASSIGN_CONFIG_VALUE(tgfb_tissue_clearance, "skin.fibroblast.tgfb_tissue_clearance");
  BDM_ASSIGN_CONFIG_VALUE(lymphatic_clearance_rate, "skin.fibroblast.lymphatic_clearance_rate");
  BDM_ASSIGN_CONFIG_VALUE(lymphatic_onset_h, "skin.fibroblast.lymphatic_onset_h");
  ...
  BDM_ASSIGN_CONFIG_VALUE(tumor_g1_factor, "skin.tumor.g1_factor");
  ...
  BDM_ASSIGN_CONFIG_VALUE(tumor_o2_threshold, "skin.tumor.o2_threshold");
  ...
  BDM_ASSIGN_CONFIG_VALUE(mmp_residual_decay, "skin.mmp.residual_decay");
  // TIMP dynamics
  BDM_ASSIGN_CONFIG_VALUE(timp_diffusion, "skin.mmp.timp_diffusion");
  BDM_ASSIGN_CONFIG_VALUE(timp_decay, "skin.mmp.timp_decay");
  BDM_ASSIGN_CONFIG_VALUE(timp_fibroblast_rate, "skin.mmp.timp_fibroblast_rate");
  BDM_ASSIGN_CONFIG_VALUE(timp_macrophage_rate, "skin.mmp.timp_macrophage_rate");
  BDM_ASSIGN_CONFIG_VALUE(timp_keratinocyte_rate, "skin.mmp.timp_keratinocyte_rate");
  BDM_ASSIGN_CONFIG_VALUE(mmp_timp_inhibition_rate, "skin.mmp.mmp_timp_inhibition_rate");
  BDM_ASSIGN_CONFIG_VALUE(matrikine_mmp_boost, "skin.mmp.matrikine_mmp_boost");
  // Pro-MMP zymogen cascade
  BDM_ASSIGN_CONFIG_VALUE(prommp_decay, "skin.mmp.prommp_decay");
  BDM_ASSIGN_CONFIG_VALUE(prommp_activation_rate, "skin.mmp.prommp_activation_rate");
  BDM_ASSIGN_CONFIG_VALUE(prommp_autocatalytic_rate, "skin.mmp.prommp_autocatalytic_rate");
  ...
  BDM_ASSIGN_CONFIG_VALUE(temperature_enabled, "skin.temperature.enabled");
  BDM_ASSIGN_CONFIG_VALUE(temperature_diffusion, "skin.temperature.diffusion");
  BDM_ASSIGN_CONFIG_VALUE(temperature_decay, "skin.temperature.decay");
  BDM_ASSIGN_CONFIG_VALUE(temperature_wound_surface, "skin.temperature.wound_surface");
  BDM_ASSIGN_CONFIG_VALUE(temperature_perfusion_warming, "skin.temperature.perfusion_warming_rate");
  BDM_ASSIGN_CONFIG_VALUE(temperature_surface_cooling, "skin.temperature.surface_cooling_rate");
  BDM_ASSIGN_CONFIG_VALUE(temperature_q10_migration, "skin.temperature.q10_migration");
  BDM_ASSIGN_CONFIG_VALUE(temperature_q10_mmp, "skin.temperature.q10_mmp");
  BDM_ASSIGN_CONFIG_VALUE(temperature_q10_biofilm, "skin.temperature.q10_biofilm");

  // Glucose module (modules/glucose/config.toml -> [skin.glucose])
  BDM_ASSIGN_CONFIG_VALUE(glucose_enabled, "skin.glucose.enabled");
  BDM_ASSIGN_CONFIG_VALUE(glucose_diffusion, "skin.glucose.diffusion");
  BDM_ASSIGN_CONFIG_VALUE(glucose_decay, "skin.glucose.decay");
  BDM_ASSIGN_CONFIG_VALUE(glucose_basal_conc, "skin.glucose.basal_conc");
  BDM_ASSIGN_CONFIG_VALUE(glucose_perfusion_supply, "skin.glucose.perfusion_supply");
  BDM_ASSIGN_CONFIG_VALUE(glucose_age_rate, "skin.glucose.age_rate");
  BDM_ASSIGN_CONFIG_VALUE(glucose_age_inflammation, "skin.glucose.age_inflammation");
  BDM_ASSIGN_CONFIG_VALUE(glucose_bacterial_consumption, "skin.glucose.bacterial_consumption");
  BDM_ASSIGN_CONFIG_VALUE(glucose_prolif_threshold, "skin.glucose.prolif_threshold");
  ...
  BDM_ASSIGN_CONFIG_VALUE(lactate_enabled, "skin.lactate.enabled");
  BDM_ASSIGN_CONFIG_VALUE(lactate_diffusion, "skin.lactate.diffusion");
  BDM_ASSIGN_CONFIG_VALUE(lactate_decay, "skin.lactate.decay");
  BDM_ASSIGN_CONFIG_VALUE(lactate_production_rate, "skin.lactate.production_rate");
  BDM_ASSIGN_CONFIG_VALUE(lactate_o2_threshold, "skin.lactate.o2_threshold");
  BDM_ASSIGN_CONFIG_VALUE(lactate_vegf_boost, "skin.lactate.vegf_boost");
  BDM_ASSIGN_CONFIG_VALUE(lactate_collagen_boost, "skin.lactate.collagen_boost");
  BDM_ASSIGN_CONFIG_VALUE(lactate_perfusion_clearance, "skin.lactate.perfusion_clearance");

  // Nitric oxide module (modules/nitric_oxide/config.toml -> [skin.nitric_oxide])
  BDM_ASSIGN_CONFIG_VALUE(nitric_oxide_enabled, "skin.nitric_oxide.enabled");
  ...
  BDM_ASSIGN_CONFIG_VALUE(diabetic_no_factor, "skin.diabetic.no_factor");

  // Senescence module (modules/senescence/config.toml -> [skin.senescence])
  BDM_ASSIGN_CONFIG_VALUE(senescence_enabled, "skin.senescence.enabled");
  BDM_ASSIGN_CONFIG_VALUE(senescence_diffusion, "skin.senescence.diffusion");
  BDM_ASSIGN_CONFIG_VALUE(senescence_decay, "skin.senescence.decay");
  BDM_ASSIGN_CONFIG_VALUE(senescence_wound_rate, "skin.senescence.wound_accumulation_rate");
  BDM_ASSIGN_CONFIG_VALUE(senescence_infl_rate, "skin.senescence.inflammation_accumulation");
  BDM_ASSIGN_CONFIG_VALUE(senescence_age_rate, "skin.senescence.age_accumulation");
  ...
  BDM_ASSIGN_CONFIG_VALUE(diabetic_senescence_factor, "skin.senescence.diabetic_accumulation_factor");

  // Neuropathy module (modules/neuropathy/config.toml -> [skin.neuropathy])
  BDM_ASSIGN_CONFIG_VALUE(neuropathy_enabled, "skin.neuropathy.enabled");
  BDM_ASSIGN_CONFIG_VALUE(neuropathy_diffusion, "skin.neuropathy.diffusion");
  BDM_ASSIGN_CONFIG_VALUE(neuropathy_decay, "skin.neuropathy.decay");
  BDM_ASSIGN_CONFIG_VALUE(neuropathy_basal_density, "skin.neuropathy.basal_nerve_density");
  ...
  BDM_ASSIGN_CONFIG_VALUE(diabetic_nerve_factor, "skin.neuropathy.diabetic_nerve_factor");
  BDM_ASSIGN_CONFIG_VALUE(diabetic_nerve_regen_factor, "skin.neuropathy.diabetic_regeneration_factor");
...
void bdm::skibidy::SimParam::ValidateConfig() const {
  ...
  check(mmp_residual_decay >= 0, "mmp_residual_decay must be non-negative");
  check(timp_decay >= 0, "timp_decay must be non-negative");
  ...
  check(timp_diffusion >= 0, "timp_diffusion must be non-negative");
