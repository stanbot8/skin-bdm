...
|--------|---------------|-------------|
| [diabetic/treatment.sh](diabetic/treatment.sh) | [treatment_study.py](../scripts/study/treatment_study.py) | Baseline + 8 treatments, Excel workbook |
| [diabetic/adaptive.sh](diabetic/adaptive.sh) | [adaptive_study.py](../scripts/study/adaptive_study.py) | Surrogate-guided combo search with synergy detection |
| [wound/skin-comparison.sh](wound/skin-comparison.sh) | batch/batch.py | Normal / aged / diabetic skin profiles |
| [tumor/study.sh](tumor/study.sh) | batch/batch.py | BCC/SCC growth rate validation |
| [run-scenarios.sh](run-scenarios.sh) | [scenario_runner.py](../scripts/study/scenario_runner.py) | Experiment scenarios across all studies |
...
|----------|------|---------|------|
| Severity spectrum | [severity_spectrum.toml](diabetic/scenarios/severity_spectrum.toml) | 5 levels (0.5x to 1.5x) | 5/config |
| Biofilm infection | [biofilm_infection.toml](diabetic/scenarios/biofilm_infection.toml) | 4 (control, early/late, +doxy) | 5/config |
| Treatment timing | [treatment_timing.toml](diabetic/scenarios/treatment_timing.toml) | 12 (3 treatments x 4 windows) | 5/config |
| Wound size | [wound_size.toml](diabetic/scenarios/wound_size.toml) | 4 (1.5mm to 8mm) | 5/config |
| Aged + diabetic | [aged_diabetic.toml](diabetic/scenarios/aged_diabetic.toml) | 4 phenotypes | 5/config |
| Chronic wound (90d) | [chronic_wound.toml](diabetic/scenarios/chronic_wound.toml) | 4 (severe + biofilm + rescue) | 3/config |
| Immune tuning | [immune_tuning.toml](diabetic/scenarios/immune_tuning.toml) | 4 (restore one axis) | 5/config |
...
| Adaptive combos | [diabetic/adaptive-example/](diabetic/adaptive-example/) | Surrogate predictions + synergy analysis |
