...
#
# Usage:
#   ./studies/diabetic-wound/adaptive.sh                      # full search (~30-45min)
#   ./studies/diabetic-wound/adaptive.sh --quick              # top-5, 2-3 runs (~10min)
#   ./studies/diabetic-wound/adaptive.sh --top-k=10           # top-10 combos
#   ./studies/diabetic-wound/adaptive.sh --treatments=hbo,npwt,growth_factor
#
...
echo "============================================"
echo "  Results in: studies/diabetic-wound/results/"
echo "  CSVs:  ${n_csv}"
echo "  Excel: ${n_xlsx}"
echo ""
