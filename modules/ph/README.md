...
|-----------|---------|-------|-------------|--------|
| `recovery_rate` | 0.003 | per step | Acidification rate, scaled by perfusion | Schneider et al. 2007 ([DOI](https://doi.org/10.1007/s00403-006-0713-x)) |
| `migration_suppression` | 0.5 | fraction | Max migration speed reduction at full alkalinity | Gethin 2007 ([Wounds UK](https://www.wounds-uk.com/journals/issue/15/article-details/the-significance-of-surface-ph-in-chronic-wounds)) |
| `mmp_boost` | 0.5 | fraction | MMP activity amplification at full alkalinity | Leveen et al. 1994 ([PubMed](https://pubmed.ncbi.nlm.nih.gov/7906335/)) |
