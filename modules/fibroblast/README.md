...
- Day 1: first wave of resident dermal fibroblasts (quiescent)
...
| `spawn_delay_h` | 24 | hours | Hours post-wound (day 1) | Darby et al. 2014 ([DOI](https://doi.org/10.2147/CCID.S50046)) |
| `spawn_waves` | 6 | count | Recruitment pulses (smoother rise curve) | Calibrated |
| `spawn_window_h` | 120 | hours | Time span for all waves (~5 days) | Darby et al. 2014 |
| `diameter` | 4.0 | um | Cell diameter | Convention |
| `density_factor` | 1.0 | multiplier | Spawn count multiplier | Convention |
| `activation_delay_h` | 60 | hours | Auto-activation timeout | Darby et al. 2014 ([DOI](https://doi.org/10.2147/CCID.S50046)) |
...
| `lifespan_h` | 1200 | hours | Hard max lifespan (50 days) | Desmouliere et al. 1995 |
| `activated_apoptosis_onset_h` | 168 | hours | Hours as activated fibroblast before stochastic death | Grinnell 1994 |
| `activated_apoptosis_rate` | 0.0003 | per step | Per-step removal probability for activated fibroblasts | Grinnell 1994 |
