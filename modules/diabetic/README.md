...
| MMP: TIMP production | `timp_production_factor` (0.4x) | Reduced TIMP-1/2 expression |
...
| `timp_production_factor` | 0.4 | multiplier | TIMP production scaling | Lobmann et al. 2002 |
...
| mmp | MMP production, TIMP production | ECM degradation imbalance |
