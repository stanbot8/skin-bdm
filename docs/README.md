...
|--------|---------|--------|
| [tissue](../modules/tissue/README.md) | Epidermal homeostasis, cell cycle, calcium-driven differentiation | Calcium, KGF, O2, Water, Stratum, BasalDensity |
...
| [inflammation](../modules/inflammation/README.md) | Cytokine signaling, Hill-function gating | Inflammation, ImmunePressure, ProInflammatory, AntiInflammatory |
...
| [mmp](../modules/mmp/README.md) | Matrix metalloproteinase ECM remodeling, TIMP inhibition | MMP, TIMP |
...
| `n_activated_fibroblasts` | count | Activated + myofibroblast fibroblasts | `[skin.fibroblast] enabled` |
...
| `mean_ph_wound` | a.u. | Mean pH alkalinity in wound | always (pH module) |
| `mean_fibrin_wound` | a.u. | Mean fibrin in wound | `[skin.hemostasis] enabled` |
| `mean_ecm_quality` | normalized | Composite ECM quality score | derived fields active |
| `mean_tissue_viability` | normalized | Composite tissue viability score | derived fields active |
| `mean_temperature_wound` | celsius | Mean temperature in wound | `[skin.temperature] enabled` |
