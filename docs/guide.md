...
python3 literature/validators/compare.py wound        # 2x2 wound healing summary
python3 literature/validators/compare.py fibroblast   # myofibroblast + collagen
python3 literature/validators/compare.py tumor        # tumor growth + Ki-67
```
